    ...
    <DataTable
      ...
      searchHint={(
        <AdvancedSearchHint
          ...
          fieldsList="name, country, members, points, damage, weeklyDamage, health, hunger, wealth, memberWealth, companies, stockpile, items, cash, equipment, weapons, cases, luck, and more."
        />
      )}
    />
  )
