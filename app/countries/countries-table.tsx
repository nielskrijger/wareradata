    ...
    <DataTable
      ...
      searchHint={(
        <AdvancedSearchHint
          ...
          fieldsList="name, code, rank, damage, weeklyDamage, wealth, citizenWealth, companies, stockpile, items, cash, equipment, weapons, population, points, health, hunger, unrest, cases, luck, and more."
        />
      )}
    />
  )
